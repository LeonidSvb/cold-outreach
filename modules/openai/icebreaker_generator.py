...
CONFIG = {
    # INPUT FILE
    "INPUT": {
        "FILE_PATH": r"C:\Users\79818\Downloads\ppc US - Canada, 11-20 _ 4 Sep   - Us - founders (2).csv",
        "TEST_ROWS": 10,  # Number of rows to process for testing
...
class IcebreakerGenerator:
    ...
    async def process_csv(self, test_mode: bool = True) -> pd.DataFrame:
...
async def main():
    ...
    # Process CSV (test mode - first 10 rows)
    df_results = await generator.process_csv(test_mode=True)
