...
# Page configuration
st.set_page_config(
    page_title="Universal AI Processor",
    page_icon="🤖",
    layout="wide",
    initial_sidebar_state="expanded"
)

# Apply common styles (embedded)
st.markdown("""
<style>
    .big-title {
        font-size: 3rem;
...
# Header
st.markdown('<div class="big-title">🤖 Universal AI Data Processor</div>', unsafe_allow_html=True)
st.markdown('<div class="subtitle">Iterative OpenAI processing with full control over prompts and columns</div>', unsafe_allow_html=True)
...
with tab1:
    ...
    if st.session_state.adding_new_prompt:
        ...
        new_prompt = st.text_area("Prompt template", height=200, placeholder="Enter your prompt instructions")
