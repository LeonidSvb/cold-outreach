        ...
        for filename in os.listdir(templates_dir):
            if filename.endswith('.txt'):
                ...
                try:
                    ...
                    print(f"Warning: Error loading template {filename}: {e}")
        ...
        for filename in os.listdir(styles_dir):
            if filename.endswith('.txt'):
                ...
                try:
                    ...
                    print(f"Warning: Error loading style {filename}: {e}")
...
- Occasional emoji but not in code
        ...
        for filename in os.listdir(offers_dir):
            if filename.endswith('.txt'):
                ...
                try:
                    ...
                    print(f"Warning: Error loading offer {filename}: {e}")
            ...
            with open(csv_path, 'r', encoding='utf-8', errors='replace') as f:
                ...
                for i, row in enumerate(reader):
                    ...
                    try:
                        ...
                        print(f"\nProcessing {i+1}: Contact at Company")
